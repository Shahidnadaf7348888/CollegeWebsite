 ...
 * Generated at: 2023-06-21 05:22:35 UTC
...
public final class StudenetLoginProcess_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//        out.println("Connected");
        ...
        ResultSet rs=st.executeQuery("select * from loginpage where name='"+us+"' and password='"+password+"'" );
       if(rs.next()){   
          String id=rs.getString(1);
          String uname=rs.getString(2);
          session.setAttribute("sid",id);
          session.setAttribute("sUserName",uname);
